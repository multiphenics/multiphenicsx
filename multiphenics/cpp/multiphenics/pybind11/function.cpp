...
namespace multiphenics_wrappers
{
  void function(py::module& m)
  {
    ...
    py::class_<multiphenics::function::BlockFunctionSpace, std::shared_ptr<multiphenics::function::BlockFunctionSpace>>
      ...
      .def_readonly("elements", &multiphenics::function::BlockFunctionSpace::elements)
      .def_readonly("mesh", &multiphenics::function::BlockFunctionSpace::mesh)
      .def_readonly("dofmaps", &multiphenics::function::BlockFunctionSpace::dofmaps)
      .def_readonly("block_dofmap", &multiphenics::function::BlockFunctionSpace::block_dofmap)
