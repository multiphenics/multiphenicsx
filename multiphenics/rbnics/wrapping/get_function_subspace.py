...
from multiphenics.block_function import BlockFunction
from multiphenics.block_function_space import BlockFunctionSpace as BlockFunctionSpace_Class
...
def get_function_subspace(block_function_space__or__block_function, block_component):
    if isinstance(block_function_space__or__block_function, BlockFunction):
        ...
        assert not isinstance(block_component, tuple), "multiphenics does not handle yet the case of sub components"
