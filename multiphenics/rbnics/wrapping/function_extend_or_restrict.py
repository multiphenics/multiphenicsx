...
def function_extend_or_restrict(block_function, block_function_components, block_V, block_V_components, weight, copy):
    ...
    if block_function_components is not None:
        ...
        assert not isinstance(block_function_components, tuple), "multiphenics does not handle yet the case of sub components"
        ...
        if isinstance(block_function_components, int):
            ...
            for block_function_component in block_function_components:
                ...
                assert not isinstance(block_function_component, tuple), "multiphenics does not handle yet the case of sub components"
            block_function_block_V_index_list = block_function_components
    else:
    ...
    if block_V_components is not None:
        ...
        assert not isinstance(block_V_components, tuple), "multiphenics does not handle yet the case of sub components"
        ...
        if isinstance(block_V_components, int):
            ...
            for block_V_component in block_V_components:
                ...
                assert not isinstance(block_V_component, tuple), "multiphenics does not handle yet the case of sub components"
            block_V_index_list = block_V_components
    else:
    ...
    if _block_function_spaces_eq(block_function_block_V, block_V, block_function_block_V_index_list, block_V_index_list):
        ...
        if not copy:
            ...
            output = multiphenics.rbnics.Function(block_V) # zero by default
        ...
        extended_block_function = multiphenics.rbnics.Function(block_V) # zero by default
        ...
        restricted_block_function = multiphenics.rbnics.Function(block_V) # zero by default
