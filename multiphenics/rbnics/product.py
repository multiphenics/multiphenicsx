...
from multiphenics.block_dirichlet_bc import BlockDirichletBC
...
from multiphenics.rbnics.wrapping import function_copy, tensor_copy
...
@backend_for("multiphenics", inputs=(ThetaType, AffineExpansionStorage, ThetaType + (None,)))
