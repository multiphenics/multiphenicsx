...
@BackendFor("multiphenics", online_backend="numpy", inputs=(BlockFunctionSpace, (str, None)))
class FunctionsList(BasicFunctionsList):
    @override
    def __init__(self, V, component=None):
        BasicFunctionsList.__init__(self, V, component, multiphenics.rbnics, multiphenics.rbnics.wrapping, rbnics.backends.numpy)
