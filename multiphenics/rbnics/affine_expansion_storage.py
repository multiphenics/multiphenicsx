...
from multiphenics import block_adjoint, block_assemble, BlockDirichletBC
...
from multiphenics.rbnics.wrapping import TupleOfBlockFormTypes

@Extends(AbstractAffineExpansionStorage)
@BackendFor("multiphenics", inputs=((tuple_of(BlockDirichletBC), tuple_of(Function.Type()), tuple_of(Matrix.Type()), tuple_of(Vector.Type())) + TupleOfBlockFormTypes, ))
