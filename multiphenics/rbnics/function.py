...
from multiphenics import BlockFunction, BlockFunctionSpace
from multiphenics.rbnics.wrapping.block_function_space import _convert_component_to_int_or_list_of_int
from rbnics.utils.decorators import backend_for

_Function_Type = BlockFunction

@backend_for("multiphenics", inputs=(BlockFunctionSpace, (str, None)), output=_Function_Type)
