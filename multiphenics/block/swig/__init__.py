...
from multiphenics.block.swig.block_compile_extension_module import block_compile_extension_module
...
cpp = block_compile_extension_module(
...
__all__ = [
    'block_compile_extension_module',
    'cpp'
]
