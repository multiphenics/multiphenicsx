...
_local_to_global_cpp_code = """
    ...
    {
        m.def("local_to_global", &local_to_global);
    }
    """
_local_to_global = compile_code("local_to_global", _local_to_global_cpp_code).local_to_global

# Assert for single block, no restriction
def assert_dof_map_single_block_no_restriction(V, block_V):
    local_dimension = V.dofmap.index_map.block_size*(V.dofmap.index_map.local_range[1] - V.dofmap.index_map.local_range[0])
    block_local_dimension = block_V.block_dofmap.index_map.local_range[1] - block_V.block_dofmap.index_map.local_range[0]
    assert local_dimension == block_local_dimension
    global_dimension = V.dofmap.index_map.block_size*V.dofmap.index_map.size_global
    block_global_dimension = block_V.block_dofmap.index_map.size_global
    ...
    for c in range(block_V.mesh.num_cells()):
        ...
        V_cell_global_dofs = [_local_to_global(V.dofmap.index_map, a) for a in V_cell_dofs]
        block_V_cell_dofs = block_V.block_dofmap.cell_dofs(c)
        ...
        block_V_cell_global_dofs = [_local_to_global(block_V.block_dofmap.index_map, b) for b in block_V_cell_dofs]
...
def assert_dof_map_two_blocks_no_restriction(V1, V2, block_V):
    local_dimension1 = V1.dofmap.index_map.block_size*(V1.dofmap.index_map.local_range[1] - V1.dofmap.index_map.local_range[0])
    local_dimension2 = V2.dofmap.index_map.block_size*(V2.dofmap.index_map.local_range[1] - V2.dofmap.index_map.local_range[0])
    block_local_dimension = block_V.block_dofmap.index_map.local_range[1] - block_V.block_dofmap.index_map.local_range[0]
    assert local_dimension1 + local_dimension2 == block_local_dimension
    global_dimension1 = V1.dofmap.index_map.block_size*V1.dofmap.index_map.size_global
    global_dimension2 = V2.dofmap.index_map.block_size*V2.dofmap.index_map.size_global
    block_global_dimension = block_V.block_dofmap.index_map.size_global
    assert global_dimension1 + global_dimension2 == block_global_dimension
    for c in range(block_V.mesh.num_cells()):
        V1_cell_dofs = V1.dofmap.cell_dofs(c)
        ...
        V2_cell_dofs = V2.dofmap.cell_dofs(c)
