...
bdofs_W2_1 = locate_dofs_topological((W.sub(2), W.sub(0)), mesh.topology.dim - 1, boundaries_1)
bc = BlockDirichletBC([[DirichletBC(bc1, bdofs_W0_1, W.sub(0))],
                       [],
                       [DirichletBC(bc0, bdofs_W2_1, W.sub(2))]])
