...
void la_petsc_module(nb::module_& m)
{
  ...
  nb::class_<multiphenicsx::la::petsc::MatSubMatrixWrapper>(m, "MatSubMatrixWrapper")
      ...
      .def("mat", [](const multiphenicsx::la::petsc::MatSubMatrixWrapper& self)
           {
              Mat mat = self.mat();
  ...
  nb::class_<multiphenicsx::la::petsc::VecSubVectorReadWrapper>(m, "VecSubVectorReadWrapper")
  ...
  nb::class_<multiphenicsx::la::petsc::VecSubVectorWrapper,
             multiphenicsx::la::petsc::VecSubVectorReadWrapper>(m, "VecSubVectorWrapper")
      .def(nb::init<Vec, IS, bool>(),
           nb::arg("x"), nb::arg("index_set"), nb::arg("ghosted") = true)
      .def(nb::init<Vec, IS, IS, const std::map<std::int32_t, std::int32_t>&, int, bool>(),
           nb::arg("x"), nb::arg("unrestricted_index_set"), nb::arg("restricted_index_set"),
  ...
  m.def(
      "create_index_sets",
      [](const std::vector<std::pair<const dolfinx::common::IndexMap*, int>>& maps, const std::vector<int> is_bs,
         bool ghosted, multiphenicsx::la::petsc::GhostBlockLayout ghost_block_layout)
      {
        std::vector<
        ...
        std::vector<IS> index_sets
            = multiphenicsx::la::petsc::create_index_sets(_maps, is_bs, ghosted, ghost_block_layout);
      ...
      nb::arg("ghost_block_layout") = multiphenicsx::la::petsc::GhostBlockLayout::intertwined);
}
