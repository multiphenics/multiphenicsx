...
DolfinxCoefficientsType_Base: typing.TypeAlias = dict[
...
MultiphenicsxRank2RestrictionsType: typing.TypeAlias = (  # type: ignore[no-any-unimported]
    tuple[mcpp.fem.DofMapRestriction, mcpp.fem.DofMapRestriction] |
    tuple[typing.Sequence[mcpp.fem.DofMapRestriction], typing.Sequence[mcpp.fem.DofMapRestriction]]
    | None
)
...
def _same_dofmap(
    ...
    try:
        dofmap1 = dofmap1._cpp_object  # type: ignore[union-attr]
    except AttributeError:
        pass

    try:
        dofmap2 = dofmap2._cpp_object  # type: ignore[union-attr]
    except AttributeError:
        pass
...
def create_vector(
    ...
    if isinstance(V, collections.abc.Sequence):
        ...
        if restriction is None:
            index_maps = [(dofmap.index_map._cpp_object, dofmap.index_map_bs) for dofmap in dofmaps]
        else:
        ...
        if kind == petsc4py.PETSc.Vec.Type.MPI:
...
def create_matrix(
    ...
    if isinstance(a, collections.abc.Sequence):
        ...
        if restriction is None:
            index_maps = (
                [function_spaces[0][i].dofmap.index_map._cpp_object for i in range(rows)],
                [function_spaces[1][j].dofmap.index_map._cpp_object for j in range(cols)])
            index_maps_bs = (
                [function_spaces[0][i].dofmap.index_map_bs for i in range(rows)],
                [function_spaces[1][j].dofmap.index_map_bs for j in range(cols)])
            dofmaps_list = (
                [function_spaces[0][i].dofmap._cpp_object.map() for i in range(rows)],
                [function_spaces[1][j].dofmap._cpp_object.map() for j in range(cols)])
            dofmaps_bounds = (
        ...
        if kind == petsc4py.PETSc.Mat.Type.NEST:
            # Create nest matrix with default types
            return mcpp.fem.petsc.create_matrix_nest(  # type: ignore[no-any-return]
                a_cpp, index_maps, index_maps_bs, dofmaps_list, dofmaps_bounds, None)
        else:
            if kind is None or isinstance(kind, str):
                # Create block matrix
                return mcpp.fem.petsc.create_matrix_block(  # type: ignore[no-any-return]
        ...
        if restriction is None:
            index_maps = [  # type: ignore[assignment]
                function_space.dofmap.index_map._cpp_object for function_space in function_spaces]  # type: ignore[attr-defined]
            ...
            dofmaps_list = [  # type: ignore[assignment]
                function_space.dofmap._cpp_object.map() for function_space in function_spaces]  # type: ignore[attr-defined]
        ...
        return mcpp.fem.petsc.create_matrix(  # type: ignore[no-any-return]
...
def _VecSubVectorWrapperBase(CppWrapperClass: type) -> type:
    ...
    class _VecSubVectorWrapperBase_Class:
        ...
        def __init__(
            ...
            restricted_index_set: petsc4py.PETSc.IS | None = None,
            unrestricted_to_restricted: dict[int, int] | None = None,
            unrestricted_to_restricted_bs: int | None = None
        ) -> None:
        ...
        def __enter__(self) -> npt.NDArray[petsc4py.PETSc.ScalarType]:  # type: ignore[valid-type]
...
def VecSubVectorWrapperBase(_VecSubVectorWrapperClass: type) -> type:
    ...
    class VecSubVectorWrapperBase_Class:
        ...
        def __init__(  # type: ignore[no-any-unimported]
            self, b: petsc4py.PETSc.Vec | None, dofmap: dcpp.fem.DofMap,
            restriction: mcpp.fem.DofMapRestriction | None = None,
            ghosted: bool = True
        ) -> None:
            if b is None:
                self._wrapper = None
                ...
                if restriction is None:  # pragma: no cover
                    ...
                    if isinstance(index_map[0], dolfinx.common.IndexMap):
                        index_map = (index_map[0]._cpp_object, index_map[1])
                    ...
                    if isinstance(unrestricted_index_map[0], dolfinx.common.IndexMap):
                        unrestricted_index_map = (unrestricted_index_map[0]._cpp_object, unrestricted_index_map[1])
        ...
        def __enter__(self) -> npt.NDArray[petsc4py.PETSc.ScalarType] | None:  # type: ignore[valid-type]
            """Return Vec content when entering the context."""
...
def BlockVecSubVectorWrapperBase(_VecSubVectorWrapperClass: type) -> type:
    ...
    class BlockVecSubVectorWrapperBase_Class:
        ...
        def __init__(  # type: ignore[no-any-unimported]
            self, b: petsc4py.PETSc.Vec | None,
            dofmaps: typing.Sequence[dcpp.fem.DofMap],
            restriction: typing.Sequence[mcpp.fem.DofMapRestriction] | None = None,
            ghosted: bool = True
        ) -> None:
            self._b = b
            ...
            if b is not None:
                if restriction is None:
                    ...
                    for dofmap in dofmaps:
                        index_map = dofmap.index_map
                        if isinstance(index_map, dolfinx.common.IndexMap):
                            index_map = index_map._cpp_object
                        index_maps.append((index_map, dofmap.index_map_bs))
                    ...
                    for dofmap in dofmaps:
                        unrestricted_index_map = dofmap.index_map
                        if isinstance(unrestricted_index_map, dolfinx.common.IndexMap):
                            unrestricted_index_map = unrestricted_index_map._cpp_object
                        unrestricted_index_maps.append((unrestricted_index_map, dofmap.index_map_bs))
        ...
        def __iter__(self) -> typing.Iterator[  # type: ignore[return,valid-type]
                npt.NDArray[petsc4py.PETSc.ScalarType]] | None:
            """Iterate over blocks."""
...
def NestVecSubVectorWrapperBase(VecSubVectorWrapperClass: type) -> type:
    ...
    class NestVecSubVectorWrapperBase_Class:
        ...
        def __init__(  # type: ignore[no-any-unimported]
            self,
            b: petsc4py.PETSc.Vec | typing.Sequence[petsc4py.PETSc.Vec] | None,
            dofmaps: typing.Sequence[dcpp.fem.DofMap],
            restriction: typing.Sequence[mcpp.fem.DofMapRestriction] | None = None,
            ghosted: bool = True
        ) -> None:
            if b is not None:
                ...
                self._b_destroy = False
                self._b = [None] * len(dofmaps)  # type: ignore[list-item]
...
def _(  # type: ignore[misc]
    ...
    """
    if b.getType() == petsc4py.PETSc.Vec.Type.NEST:
        ...
        with BlockVecSubVectorWrapper(b, dofmaps, restriction) as block_b:
            for b_sub, L_sub, constant, coeff in zip(block_b, L, constants, coeffs):
                dcpp.fem.assemble_vector(b_sub, L_sub._cpp_object, constant, coeff)  # type: ignore[arg-type]
    else:  # single form
        if restriction is None:
...
class _MatSubMatrixWrapper:
    ...
    def __init__(
        ...
        unrestricted_index_sets: tuple[petsc4py.PETSc.IS, petsc4py.PETSc.IS],
        restricted_index_sets: tuple[petsc4py.PETSc.IS, petsc4py.PETSc.IS] | None = None,
        unrestricted_to_restricted: tuple[dict[int, int], dict[int, int]] | None = None,
        unrestricted_to_restricted_bs: tuple[int, int] | None = None
    ) -> None:
        if restricted_index_sets is None:
            ...
            self._cpp_object = mcpp.la.petsc.MatSubMatrixWrapper(
                ...
                unrestricted_to_restricted,
                unrestricted_to_restricted_bs)
        self._cpp_object_mat: petsc4py.PETSc.Mat | None = None
...
class MatSubMatrixWrapper:
    ...
    def __init__(  # type: ignore[no-any-unimported]
        ...
        restriction: tuple[mcpp.fem.DofMapRestriction, mcpp.fem.DofMapRestriction] | None = None
    ) -> None:
        ...
        if restriction is None:  # pragma: no cover
            ...
            for i in range(2):
                if isinstance(index_maps_[i], dolfinx.common.IndexMap):
                    index_maps_[i] = index_maps_[i]._cpp_object  # type:ignore [attr-defined]
            index_maps = (
                (index_maps_[0], dofmaps[0].index_map_bs),
                (index_maps_[1], dofmaps[1].index_map_bs))
            index_sets = (
            ...
            unrestricted_index_maps_ = [
                dofmaps[0].index_map,
                dofmaps[1].index_map
            ]
            for i in range(2):
                if isinstance(unrestricted_index_maps_[i], dolfinx.common.IndexMap):
                    unrestricted_index_maps_[i] = unrestricted_index_maps_[i]._cpp_object  # type:ignore [attr-defined]
            unrestricted_index_maps = (
                (unrestricted_index_maps_[0], dofmaps[0].index_map_bs),
                (unrestricted_index_maps_[1], dofmaps[1].index_map_bs))
...
class BlockMatSubMatrixWrapper:
    ...
    def __init__(  # type: ignore[no-any-unimported]
        ...
        restriction: tuple[
            typing.Sequence[mcpp.fem.DofMapRestriction], typing.Sequence[mcpp.fem.DofMapRestriction]
        ] | None = None
    ) -> None:
        self._A = A
        assert len(dofmaps) == 2
        if restriction is None:
            index_maps_ = [
                [dofmap.index_map for dofmap in dofmaps[0]],
                [dofmap.index_map for dofmap in dofmaps[0]]
            ]
            for i in range(2):
                for j in range(len(index_maps_[i])):
                    if isinstance(index_maps_[i][j], dolfinx.common.IndexMap):
                        index_maps_[i][j] = index_maps_[i][j]._cpp_object  # type:ignore [attr-defined]
            index_maps = (
                [
                    (index_map, dofmap.index_map_bs)
                    for (dofmap, index_map) in zip(dofmaps[0], index_maps_[0])
                ],
                [
                    (index_map, dofmap.index_map_bs)
                    for (dofmap, index_map) in zip(dofmaps[1], index_maps_[1])
                ]
            )
            index_sets = (
            ...
            for i in range(2):
                for j in range(len(unrestricted_index_maps_[i])):
                    if isinstance(unrestricted_index_maps_[i][j], dolfinx.common.IndexMap):
                        unrestricted_index_maps_[i][j] = unrestricted_index_maps_[i][j]._cpp_object  # type:ignore [attr-defined]
            unrestricted_index_maps = (
                [
                    (unrestricted_index_map, dofmap.index_map_bs)
                    for (dofmap, unrestricted_index_map) in zip(dofmaps[0], unrestricted_index_maps_[0])
                ],
                [
                    (unrestricted_index_map, dofmap.index_map_bs)
                    for (dofmap, unrestricted_index_map) in zip(dofmaps[1], unrestricted_index_maps_[1])
                ]
            )
            unrestricted_index_sets = (
                mcpp.la.petsc.create_index_sets(
...
def _(  # type: ignore[misc]
    ...
    if A.getType() == petsc4py.PETSc.Mat.Type.NEST:
        ...
        with NestMatSubMatrixWrapper(A, dofmaps, restriction) as nest_A:  # type: ignore[arg-type]
        ...
        with NestMatSubMatrixWrapper(A, dofmaps, restriction) as nest_A:  # type: ignore[arg-type]
            for i, j, A_sub in nest_A:
                if function_spaces[0][i] is function_spaces[1][j]:
                    a_sub = a[i][j]
                    if a_sub is not None:
                        dcpp.fem.petsc.insert_diagonal(A_sub, function_spaces[0][i]._cpp_object, bcs_cpp, diag)  # type: ignore[arg-type]
        ...
        # Assemble form
        with BlockMatSubMatrixWrapper(A, dofmaps, restriction) as block_A:  # type: ignore[arg-type]
        ...
        if restriction is None:
            ...
            if function_spaces[0] is function_spaces[1]:
                ...
                # Set diagonal value
                dcpp.fem.petsc.insert_diagonal(A, function_spaces[0]._cpp_object, bcs_cpp, diag)  # type: ignore[arg-type, attr-defined]
        else:
            ...
            if function_spaces[0] is function_spaces[1]:
                ...
                # Set diagonal value
                with MatSubMatrixWrapper(A, dofmaps, restriction) as A_sub:  # type: ignore[arg-type]
                    dcpp.fem.petsc.insert_diagonal(A_sub, function_spaces[0]._cpp_object, bcs_cpp, diag)  # type: ignore[arg-type, attr-defined]
...
def apply_lifting(
    ...
    if not isinstance(a[0], collections.abc.Sequence):  # single form
        ...
        function_spaces: tuple[list[dolfinx.fem.FunctionSpace], list[dolfinx.fem.FunctionSpace]] = (  # type: ignore
            dolfinx.fem.extract_function_spaces(a, 0), dolfinx.fem.extract_function_spaces(a, 1))  # type: ignore[arg-type]
...
def set_bc(
    ...
    if not isinstance(bcs[0], collections.abc.Sequence):  # single form
        if restriction is None:
            if x0 is not None:
                x0 = x0.array_r  # type: ignore[assignment]
            for bc in bcs:
                bc.set(b.array_w, x0, alpha)  # type: ignore[arg-type,union-attr]
        else:
    ...
    elif b.getType() == petsc4py.PETSc.Vec.Type.NEST:
        if restriction is None:
        ...
        if restriction is None:
            ...
            dofmaps = b.getAttr("_dofmaps")  # type: ignore[assignment]
        ...
        if restriction_x0 is None:
            if x0 is None:
                ...
                # upstream dolfinx imposes a similar requirement using the attribute _blocks
                dofmaps_x0 = x0.getAttr("_dofmaps")  # type: ignore[assignment]
...
class LinearProblem:
    ...
    def __init__(
        ...
        if petsc_options is not None:
            ...
            for k in petsc_options.keys():
                del opts[k]  # type: ignore[attr-defined]
    ...
    def solve(self) -> dolfinx.fem.Function[dolfinx.typing.Scalar] | typing.Sequence[
        ...
        dolfinx.la.petsc._ghost_update(
            self.x, petsc4py.PETSc.InsertMode.INSERT,   # type: ignore[arg-type]
            petsc4py.PETSc.ScatterMode.FORWARD  # type: ignore[arg-type]
        )
        assign(self.x, self.u, self.restriction)  # type: ignore[arg-type]
        return self.u
    ...
    @property
    def P_mat(self) -> petsc4py.PETSc.Mat | None:
        """Preconditioner matrix."""
        return self._P_mat

    @property
    def b(self) -> petsc4py.PETSc.Vec:
        """Right-hand side vector."""
        return self._b

    @property
    def x(self) -> petsc4py.PETSc.Vec:
        """
        Solution vector.
...
def assemble_residual(
    ...
    dolfinx.la.petsc._ghost_update(
        x, petsc4py.PETSc.InsertMode.INSERT,   # type: ignore[arg-type]
        petsc4py.PETSc.ScatterMode.FORWARD  # type: ignore[arg-type]
    )

    # Copy the input vector into the `dolfinx.fem.Function` used in the forms
    assign(x, u, restriction)  # type: ignore[arg-type]
    ...
    if isinstance(jacobian, collections.abc.Sequence):  # nest or block forms
        ...
        apply_lifting(
            b, jacobian, bcs=bcs1, x0=x, alpha=-1.0, restriction=restriction, restriction_x0=restriction_x0)  # type: ignore[arg-type]
        dolfinx.la.petsc._ghost_update(
            b, petsc4py.PETSc.InsertMode.ADD,  # type: ignore[arg-type]
            petsc4py.PETSc.ScatterMode.REVERSE  # type: ignore[arg-type]
        )
    ...
    dolfinx.la.petsc._ghost_update(
        b, petsc4py.PETSc.InsertMode.INSERT,  # type: ignore[arg-type]
        petsc4py.PETSc.ScatterMode.FORWARD  # type: ignore[arg-type]
    )
...
class NonlinearProblem:
    ...
    def __init__(
        ...
        *,
        ...
        if P is not None:  # pragma: no cover
            ...
            self._preconditioner = None  # type: ignore[assignment]
    ...
    def solve(self) -> dolfinx.fem.Function[dolfinx.typing.Scalar] | typing.Sequence[
        ...
        assign(self.x, self.u, restriction=self.restriction)  # type: ignore[arg-type]
        return self.u
    ...
    def J(self) -> DolfinxRank2FormsType[dolfinx.typing.Scalar]:
        ...
        return self._J  # type: ignore[return-value]
    ...
    @property
    def solver(self) -> petsc4py.PETSc.SNES:
        """The SNES solver."""
        return self._snes
